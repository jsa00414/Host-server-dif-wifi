...
.x-btn-text[class*="icon-"],.x-btn-text.navi-button,button.navi-button,
.x-menu-item-icon[class*="icon-"]{
  background-image:none!important;background-position:center!important;background-repeat:no-repeat!important;
  position:relative!important;overflow:visible!important;min-height:22px!important}
/* Icon-only toolbars / navi: hide leftover PNG glyph text */
#icon-panel .x-btn-text[class*="icon-"],
#icon-panel .x-btn-text.navi-button,
#location-buttons .x-btn-text.navi-button,
#location-buttons-ie .x-btn-text.navi-button,
.navi-button.x-btn-text{
  color:transparent!important;text-indent:-9999px!important;overflow:hidden!important;
  width:28px!important;height:28px!important;padding:0!important;margin:0 auto!important}
/* Menu bar labels stay visible; icon sits on the left via ::before */
#menu-bar .x-btn-text[class*="icon-"]{
  color:var(--sm-text)!important;text-indent:0!important;overflow:visible!important;
  width:auto!important;height:auto!important;min-height:28px!important;
  padding:4px 8px 4px 26px!important;margin:0!important;line-height:20px!important}
#menu-bar .x-btn-text[class*="icon-"]::before{
  position:absolute!important;left:4px!important;top:50%!important;
  transform:translateY(-50%)!important;margin:0!important}
.x-btn-icon .x-btn-text,.x-btn-text-icon .x-btn-icon-small-left{filter:none!important}
.x-btn-text.icon-file::before,.x-menu-item-icon.icon-file{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
...
.x-btn-over .x-btn-text.icon-file::before,.x-btn-focus .x-btn-text.icon-file::before,
.x-menu-item-active .x-menu-item-icon.icon-file{background-color:var(--sm-accent)!important}
.x-btn-text.icon-fileOpen::before,.x-menu-item-icon.icon-fileOpen{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-fileOpen::before,.x-btn-focus .x-btn-text.icon-fileOpen::before,
.x-menu-item-active .x-menu-item-icon.icon-fileOpen{background-color:var(--sm-accent)!important}
.x-btn-text.icon-download::before,.x-menu-item-icon.icon-download{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-download::before,.x-btn-focus .x-btn-text.icon-download::before,
.x-menu-item-active .x-menu-item-icon.icon-download{background-color:var(--sm-accent)!important}
.x-btn-text.icon-upload::before,.x-menu-item-icon.icon-upload{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-upload::before,.x-btn-focus .x-btn-text.icon-upload::before,
.x-menu-item-active .x-menu-item-icon.icon-upload{background-color:var(--sm-accent)!important}
.x-btn-text.icon-newfolder::before,.x-menu-item-icon.icon-newfolder{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-newfolder::before,.x-btn-focus .x-btn-text.icon-newfolder::before,
.x-menu-item-active .x-menu-item-icon.icon-newfolder{background-color:var(--sm-accent)!important}
.x-btn-text.icon-remove::before,.x-menu-item-icon.icon-remove{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-remove::before,.x-btn-focus .x-btn-text.icon-remove::before,
.x-menu-item-active .x-menu-item-icon.icon-remove{background-color:var(--sm-accent)!important}
.x-btn-text.icon-rename::before,.x-menu-item-icon.icon-rename{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-rename::before,.x-btn-focus .x-btn-text.icon-rename::before,
.x-menu-item-active .x-menu-item-icon.icon-rename{background-color:var(--sm-accent)!important}
.x-btn-text.icon-copy::before,.x-menu-item-icon.icon-copy{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  -webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M16%204h2a2%202%200%200%201%202%202v14a2%202%200%200%201-2%202H6a2%202%200%200%201-2-2V6a2%202%200%200%201%202-2h2M9%202h6a1%201%200%200%201%201%201v1H8V3a1%201%200%200%201%201-1z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M16%204h2a2%202%200%200%201%202%202v14a2%202%200%200%201-2%202H6a2%202%200%200%201-2-2V6a2%202%200%200%201%202-2h2M9%202h6a1%201%200%200%201%201%201v1H8V3a1%201%200%200%201%201-1z%27%2F%3E%3C%2Fsvg%3E")!important;
  -webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-copy::before,.x-btn-focus .x-btn-text.icon-copy::before,
.x-menu-item-active .x-menu-item-icon.icon-copy{background-color:var(--sm-accent)!important}
.x-btn-text.icon-move::before,.x-menu-item-icon.icon-move{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-move::before,.x-btn-focus .x-btn-text.icon-move::before,
.x-menu-item-active .x-menu-item-icon.icon-move{background-color:var(--sm-accent)!important}
.x-btn-text.icon-copyurl::before,.x-menu-item-icon.icon-copyurl{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  -webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M10%2013a5%205%200%200%200%207.54.54l3-3a5%205%200%200%200-7.07-7.07l-1.72%201.71M14%2011a5%205%200%200%200-7.54-.54l-3%203a5%205%200%200%200%207.07%207.07l1.71-1.71%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M10%2013a5%205%200%200%200%207.54.54l3-3a5%205%200%200%200-7.07-7.07l-1.72%201.71M14%2011a5%205%200%200%200-7.54-.54l-3%203a5%205%200%200%200%207.07%207.07l1.71-1.71%27%2F%3E%3C%2Fsvg%3E")!important;
  -webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-copyurl::before,.x-btn-focus .x-btn-text.icon-copyurl::before,
.x-menu-item-active .x-menu-item-icon.icon-copyurl{background-color:var(--sm-accent)!important}
.x-btn-text.icon-mailurl::before,.x-menu-item-icon.icon-mailurl{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-mailurl::before,.x-btn-focus .x-btn-text.icon-mailurl::before,
.x-menu-item-active .x-menu-item-icon.icon-mailurl{background-color:var(--sm-accent)!important}
.x-btn-text.icon-onetimeurl::before,.x-menu-item-icon.icon-onetimeurl{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-onetimeurl::before,.x-btn-focus .x-btn-text.icon-onetimeurl::before,
.x-menu-item-active .x-menu-item-icon.icon-onetimeurl{background-color:var(--sm-accent)!important}
.x-btn-text.icon-thumb-clear::before,.x-menu-item-icon.icon-thumb-clear{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-thumb-clear::before,.x-btn-focus .x-btn-text.icon-thumb-clear::before,
.x-menu-item-active .x-menu-item-icon.icon-thumb-clear{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view::before,.x-menu-item-icon.icon-view{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view::before,.x-btn-focus .x-btn-text.icon-view::before,
.x-menu-item-active .x-menu-item-icon.icon-view{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view-list::before,.x-menu-item-icon.icon-view-list{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view-list::before,.x-btn-focus .x-btn-text.icon-view-list::before,
.x-menu-item-active .x-menu-item-icon.icon-view-list{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view-small::before,.x-menu-item-icon.icon-view-small{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view-small::before,.x-btn-focus .x-btn-text.icon-view-small::before,
.x-menu-item-active .x-menu-item-icon.icon-view-small{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view-medium::before,.x-menu-item-icon.icon-view-medium{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view-medium::before,.x-btn-focus .x-btn-text.icon-view-medium::before,
.x-menu-item-active .x-menu-item-icon.icon-view-medium{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view-large::before,.x-menu-item-icon.icon-view-large{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view-large::before,.x-btn-focus .x-btn-text.icon-view-large::before,
.x-menu-item-active .x-menu-item-icon.icon-view-large{background-color:var(--sm-accent)!important}
.x-btn-text.icon-view-sidebyside::before,.x-menu-item-icon.icon-view-sidebyside{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  -webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v18H3zM13%203h8v18h-8z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v18H3zM13%203h8v18h-8z%27%2F%3E%3C%2Fsvg%3E")!important;
  -webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-view-sidebyside::before,.x-btn-focus .x-btn-text.icon-view-sidebyside::before,
.x-menu-item-active .x-menu-item-icon.icon-view-sidebyside{background-color:var(--sm-accent)!important}
.x-btn-text.icon-help::before,.x-menu-item-icon.icon-help{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-help::before,.x-btn-focus .x-btn-text.icon-help::before,
.x-menu-item-active .x-menu-item-icon.icon-help{background-color:var(--sm-accent)!important}
.x-btn-text.icon-settings::before,.x-menu-item-icon.icon-settings{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;background-image:none!important;
  -webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2015a3%203%200%201%200%200-6%203%203%200%200%200%200%206zM19.4%2015a1.65%201.65%200%200%200%20.33%201.82l.06.06a2%202%200%201%201-2.83%202.83l-.06-.06a1.65%201.65%200%200%200-1.82-.33%201.65%201.65%200%200%200-1%201.51V21a2%202%200%201%201-4%200v-.09A1.65%201.65%200%200%200%209%2019.4a1.65%201.65%200%200%200-1.82.33l-.06.06a2%202%200%201%201-2.83-2.83l.06-.06A1.65%201.65%200%200%200%204.68%2015a1.65%201.65%200%200%200-1.51-1H3a2%202%200%201%201%200-4h.09A1.65%201.65%200%200%200%204.6%209a1.65%201.65%200%200%200-.33-1.82l-.06-.06a2%202%200%201%201%202.83-2.83l.06.06A1.65%201.65%200%200%200%209%204.68a1.65%201.65%200%200%200%201-1.51V3a2%202%200%201%201%204%200v.09a1.65%201.65%200%200%200%201%201.51%201.65%201.65%200%200%200%201.82-.33l.06-.06a2%202%200%201%201%202.83%202.83l-.06.06A1.65%201.65%200%200%200%2019.4%209a1.65%201.65%200%200%200%201.51%201H21a2%202%200%201%201%200%204h-.09a1.65%201.65%200%200%200-1.51%201z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2015a3%203%200%201%200%200-6%203%203%200%200%200%200%206zM19.4%2015a1.65%201.65%200%200%200%20.33%201.82l.06.06a2%202%200%201%201-2.83%202.83l-.06-.06a1.65%201.65%200%200%200-1.82-.33%201.65%201.65%200%200%200-1%201.51V21a2%202%200%201%201-4%200v-.09A1.65%201.65%200%200%200%209%2019.4a1.65%201.65%200%200%200-1.82.33l-.06.06a2%202%200%201%201-2.83-2.83l.06-.06A1.65%201.65%200%200%200%204.68%2015a1.65%201.65%200%200%200-1.51-1H3a2%202%200%201%201%200-4h.09A1.65%201.65%200%200%200%204.6%209a1.65%201.65%200%200%200-.33-1.82l-.06-.06a2%202%200%201%201%202.83-2.83l.06.06A1.65%201.65%200%200%200%209%204.68a1.65%201.65%200%200%200%201-1.51V3a2%202%200%201%201%204%200v.09a1.65%201.65%200%200%200%201%201.51%201.65%201.65%200%200%200%201.82-.33l.06-.06a2%202%200%201%201%202.83%202.83l-.06.06A1.65%201.65%200%200%200%2019.4%209a1.65%201.65%200%200%200%201.51%201H21a2%202%200%201%201%200%204h-.09a1.65%201.65%200%200%200-1.51%201z%27%2F%3E%3C%2Fsvg%3E")!important;
  -webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-over .x-btn-text.icon-settings::before,.x-btn-focus .x-btn-text.icon-settings::before,
.x-menu-item-active .x-menu-item-icon.icon-settings{background-color:var(--sm-accent)!important}
.x-menu-item-icon{
  ...
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-menu-item-icon.icon-file{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M14%202H6a2%202%200%200%200-2%202v16a2%202%200%200%200%202%202h12a2%202%200%200%200%202-2V8zM14%202v6h6%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M14%202H6a2%202%200%200%200-2%202v16a2%202%200%200%200%202%202h12a2%202%200%200%200%202-2V8zM14%202v6h6%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-fileOpen{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M22%2019a2%202%200%200%201-2%202H4a2%202%200%200%201-2-2V5a2%202%200%200%201%202-2h5l2%203h9a2%202%200%200%201%202%202z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M22%2019a2%202%200%200%201-2%202H4a2%202%200%200%201-2-2V5a2%202%200%200%201%202-2h5l2%203h9a2%202%200%200%201%202%202z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-download{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M21%2015v4a2%202%200%200%201-2%202H5a2%202%200%200%201-2-2v-4M7%2010l5%205%205-5M12%2015V3%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M21%2015v4a2%202%200%200%201-2%202H5a2%202%200%200%201-2-2v-4M7%2010l5%205%205-5M12%2015V3%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-upload{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M21%2015v4a2%202%200%200%201-2%202H5a2%202%200%200%201-2-2v-4M17%208l-5-5-5%205M12%203v12%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M21%2015v4a2%202%200%200%201-2%202H5a2%202%200%200%201-2-2v-4M17%208l-5-5-5%205M12%203v12%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-newfolder{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M22%2019a2%202%200%200%201-2%202H4a2%202%200%200%201-2-2V5a2%202%200%200%201%202-2h5l2%203h9a2%202%200%200%201%202%202zM12%2011v6M9%2014h6%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M22%2019a2%202%200%200%201-2%202H4a2%202%200%200%201-2-2V5a2%202%200%200%201%202-2h5l2%203h9a2%202%200%200%201%202%202zM12%2011v6M9%2014h6%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-remove{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%206h18M19%206v14a2%202%200%200%201-2%202H7a2%202%200%200%201-2-2V6m3%200V4a2%202%200%200%201%202-2h4a2%202%200%200%201%202%202v2%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%206h18M19%206v14a2%202%200%200%201-2%202H7a2%202%200%200%201-2-2V6m3%200V4a2%202%200%200%201%202-2h4a2%202%200%200%201%202%202v2%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-rename{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2020h9M16.5%203.5a2.12%202.12%200%200%201%203%203L7%2019l-4%201%201-4L16.5%203.5z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2020h9M16.5%203.5a2.12%202.12%200%200%201%203%203L7%2019l-4%201%201-4L16.5%203.5z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-copy{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M16%204h2a2%202%200%200%201%202%202v14a2%202%200%200%201-2%202H6a2%202%200%200%201-2-2V6a2%202%200%200%201%202-2h2M9%202h6a1%201%200%200%201%201%201v1H8V3a1%201%200%200%201%201-1z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M16%204h2a2%202%200%200%201%202%202v14a2%202%200%200%201-2%202H6a2%202%200%200%201-2-2V6a2%202%200%200%201%202-2h2M9%202h6a1%201%200%200%201%201%201v1H8V3a1%201%200%200%201%201-1z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-move{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M5%2012h14M12%205l7%207-7%207%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M5%2012h14M12%205l7%207-7%207%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-copyurl{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M10%2013a5%205%200%200%200%207.54.54l3-3a5%205%200%200%200-7.07-7.07l-1.72%201.71M14%2011a5%205%200%200%200-7.54-.54l-3%203a5%205%200%200%200%207.07%207.07l1.71-1.71%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M10%2013a5%205%200%200%200%207.54.54l3-3a5%205%200%200%200-7.07-7.07l-1.72%201.71M14%2011a5%205%200%200%200-7.54-.54l-3%203a5%205%200%200%200%207.07%207.07l1.71-1.71%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-mailurl{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M4%204h16c1.1%200%202%20.9%202%202v12c0%201.1-.9%202-2%202H4c-1.1%200-2-.9-2-2V6c0-1.1.9-2%202-2zM22%206l-10%207L2%206%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M4%204h16c1.1%200%202%20.9%202%202v12c0%201.1-.9%202-2%202H4c-1.1%200-2-.9-2-2V6c0-1.1.9-2%202-2zM22%206l-10%207L2%206%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-onetimeurl{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%202v2M12%2020v2M4.93%204.93l1.41%201.41M17.66%2017.66l1.41%201.41M2%2012h2M20%2012h2M4.93%2019.07l1.41-1.41M17.66%206.34l1.41-1.41M12%208a4%204%200%201%201%200%208%204%204%200%200%201%200-8z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%202v2M12%2020v2M4.93%204.93l1.41%201.41M17.66%2017.66l1.41%201.41M2%2012h2M20%2012h2M4.93%2019.07l1.41-1.41M17.66%206.34l1.41-1.41M12%208a4%204%200%201%201%200%208%204%204%200%200%201%200-8z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-thumb-clear{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%206h18M8%206V4a2%202%200%200%201%202-2h4a2%202%200%200%201%202%202v2M19%206l-1%2014a2%202%200%200%201-2%202H8a2%202%200%200%201-2-2L5%206%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%206h18M8%206V4a2%202%200%200%201%202-2h4a2%202%200%200%201%202%202v2M19%206l-1%2014a2%202%200%200%201-2%202H8a2%202%200%200%201-2-2L5%206%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M1%2012s4-8%2011-8%2011%208%2011%208-4%208-11%208-11-8-11-8zM12%209a3%203%200%201%201%200%206%203%203%200%200%201%200-6z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M1%2012s4-8%2011-8%2011%208%2011%208-4%208-11%208-11-8-11-8zM12%209a3%203%200%201%201%200%206%203%203%200%200%201%200-6z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view-list{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M8%206h13M8%2012h13M8%2018h13M3%206h.01M3%2012h.01M3%2018h.01%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M8%206h13M8%2012h13M8%2018h13M3%206h.01M3%2012h.01M3%2018h.01%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view-small{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h7v7H3zM14%203h7v7h-7zM14%2014h7v7h-7zM3%2014h7v7H3z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h7v7H3zM14%203h7v7h-7zM14%2014h7v7h-7zM3%2014h7v7H3z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view-medium{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v8H3zM13%203h8v8h-8zM3%2013h8v8H3zM13%2013h8v8h-8z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v8H3zM13%203h8v8h-8zM3%2013h8v8H3zM13%2013h8v8h-8z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view-large{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h18v18H3z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h18v18H3z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-view-sidebyside{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v18H3zM13%203h8v18h-8z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M3%203h8v18H3zM13%203h8v18h-8z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-help{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2022a10%2010%200%201%201%200-20%2010%2010%200%200%201%200%2020zM9.09%209a3%203%200%200%201%205.83%201c0%202-3%203-3%203M12%2017h.01%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2022a10%2010%200%201%201%200-20%2010%2010%200%200%201%200%2020zM9.09%209a3%203%200%200%201%205.83%201c0%202-3%203-3%203M12%2017h.01%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-menu-item-icon.icon-settings{-webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2015a3%203%200%201%200%200-6%203%203%200%200%200%200%206zM19.4%2015a1.65%201.65%200%200%200%20.33%201.82l.06.06a2%202%200%201%201-2.83%202.83l-.06-.06a1.65%201.65%200%200%200-1.82-.33%201.65%201.65%200%200%200-1%201.51V21a2%202%200%201%201-4%200v-.09A1.65%201.65%200%200%200%209%2019.4a1.65%201.65%200%200%200-1.82.33l-.06.06a2%202%200%201%201-2.83-2.83l.06-.06A1.65%201.65%200%200%200%204.68%2015a1.65%201.65%200%200%200-1.51-1H3a2%202%200%201%201%200-4h.09A1.65%201.65%200%200%200%204.6%209a1.65%201.65%200%200%200-.33-1.82l-.06-.06a2%202%200%201%201%202.83-2.83l.06.06A1.65%201.65%200%200%200%209%204.68a1.65%201.65%200%200%200%201-1.51V3a2%202%200%201%201%204%200v.09a1.65%201.65%200%200%200%201%201.51%201.65%201.65%200%200%200%201.82-.33l.06-.06a2%202%200%201%201%202.83%202.83l-.06.06A1.65%201.65%200%200%200%2019.4%209a1.65%201.65%200%200%200%201.51%201H21a2%202%200%201%201%200%204h-.09a1.65%201.65%200%200%200-1.51%201z%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M12%2015a3%203%200%201%200%200-6%203%203%200%200%200%200%206zM19.4%2015a1.65%201.65%200%200%200%20.33%201.82l.06.06a2%202%200%201%201-2.83%202.83l-.06-.06a1.65%201.65%200%200%200-1.82-.33%201.65%201.65%200%200%200-1%201.51V21a2%202%200%201%201-4%200v-.09A1.65%201.65%200%200%200%209%2019.4a1.65%201.65%200%200%200-1.82.33l-.06.06a2%202%200%201%201-2.83-2.83l.06-.06A1.65%201.65%200%200%200%204.68%2015a1.65%201.65%200%200%200-1.51-1H3a2%202%200%201%201%200-4h.09A1.65%201.65%200%200%200%204.6%209a1.65%201.65%200%200%200-.33-1.82l-.06-.06a2%202%200%201%201%202.83-2.83l.06.06A1.65%201.65%200%200%200%209%204.68a1.65%201.65%200%200%200%201-1.51V3a2%202%200%201%201%204%200v.09a1.65%201.65%200%200%200%201%201.51%201.65%201.65%200%200%200%201.82-.33l.06-.06a2%202%200%201%201%202.83%202.83l-.06.06A1.65%201.65%200%200%200%2019.4%209a1.65%201.65%200%200%200%201.51%201H21a2%202%200%201%201%200%204h-.09a1.65%201.65%200%200%200-1.51%201z%27%2F%3E%3C%2Fsvg%3E")!important;background-color:var(--sm-muted)!important}
.x-btn-text.navi-button,button.navi-button{background-image:none!important;background:transparent!important}
.x-btn-text.navi-button::before{
  content:""!important;display:block!important;width:18px!important;height:18px!important;
  margin:5px auto!important;background-color:var(--sm-muted)!important;
  -webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;
  -webkit-mask-position:center!important;mask-position:center!important;
  -webkit-mask-size:contain!important;mask-size:contain!important}
.x-btn-text.navi-button[style*="back.png"]::before,
button.navi-button[style*="back.png"]::before,
.x-btn-text[style*="back.png"]::before{
...
.x-btn-text.navi-button[style*="forward.png"]::before,
button.navi-button[style*="forward.png"]::before,
.x-btn-text[style*="forward.png"]::before{
  -webkit-mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M5%2012h14M12%205l7%207-7%207%27%2F%3E%3C%2Fsvg%3E")!important;mask-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%20fill%3D%27none%27%20stroke%3D%27black%27%20stroke-width%3D%272%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%3E%3Cpath%20d%3D%27M5%2012h14M12%205l7%207-7%207%27%2F%3E%3C%2Fsvg%3E")!important}
.x-btn-text.navi-button[style*="up.png"]::before,
button.navi-button[style*="up.png"]::before,
.x-btn-text[style*="up.png"]::before{
...
.x-btn-text.navi-button[style*="etc_history.png"]::before,
button.navi-button[style*="etc_history.png"]::before,
.x-btn-text[style*="etc_history.png"]::before{
...
.x-btn-text.navi-button[style*="alert.png"]::before,
button.navi-button[style*="alert.png"]::before,
.x-btn-text[style*="alert.png"]::before{
...
.x-btn-text.navi-button[style*="search.png"]::before,
button.navi-button[style*="search.png"]::before,
.x-btn-text[style*="search.png"]::before{
...
.x-btn-text.navi-button[style*="etc_login.png"]::before,
button.navi-button[style*="etc_login.png"]::before,
.x-btn-text[style*="etc_login.png"]::before{
...
.x-btn-text.navi-button[style*="etc_logout.png"]::before,
button.navi-button[style*="etc_logout.png"]::before,
.x-btn-text[style*="etc_logout.png"]::before{
...
#navi-button-up.x-btn-over .x-btn-text::before{background-color:var(--sm-accent)!important}
"""
