...
NAS_FILES_SNIPPET = (
    ...
    # Sencha Touch: fill iframe, but keep inner scroller touchable.
    ...
    "if(++_smFitN>=30)clearInterval(_smFitT);"
    "},400);"
    "if(document.readyState==='complete')setTimeout(function(){smNasFit(true);},0);"
    "else window.addEventListener('load',function(){"
    "setTimeout(function(){smNasFit(true);},0);"
    "setTimeout(function(){smNasFit(true);},400);"
    "setTimeout(function(){smNasFit(true);},1200);"
    "},false);"
    "var _smExtWait=setInterval(function(){"
    "if(smPatchExtDom()&&window.Ext&&Ext.onReady){"
    "clearInterval(_smExtWait);"
    "try{Ext.onReady(function(){"
    "setTimeout(function(){smNasFit(true);},0);"
    "setTimeout(function(){smNasFit(true);},300);"
    "setTimeout(function(){smNasFit(true);},1000);"
    "});}catch(e){}"
    "}"
    "},100);"
    "}catch(e){}"
