...
NAS_FILES_SNIPPET = (
    ...
    "v.style.cssText='display:none;position:fixed;inset:0;z-index:2147483646;background:rgba(8,10,14,.94);"
    "color:#f2f4f8;font:600 14px/1.3 system-ui,sans-serif;-webkit-tap-highlight-color:transparent';';"
    "v.innerHTML='<div style=\"display:flex;align-items:center;gap:10px;padding:10px 12px;'+"
    "'padding-top:max(10px,env(safe-area-inset-top));box-sizing:border-box;background:#111827;\"'+"
    "'><button type=\"button\" id=\"sm-nas-viewer-close\" style=\"flex:0 0 auto;min-width:44px;min-height:44px;'+"
    "'border:0;border-radius:10px;background:#374151;color:#fff;font:700 18px/1 system-ui,sans-serif;\"'+"
    "'aria-label=\"Close\">\\u2715</button>'+"
    "'<div id=\"sm-nas-viewer-title\" style=\"flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;'+"
    "'white-space:nowrap;font-weight:600\"></div>'+"
    "'<a id=\"sm-nas-viewer-dl\" href=\"#\" style=\"flex:0 0 auto;min-height:44px;padding:0 14px;display:inline-flex;'+"
    "'align-items:center;border-radius:10px;background:#2563eb;color:#fff;text-decoration:none;font-weight:700\">Download</a></div>'+"
    "'<div id=\"sm-nas-viewer-body\" style=\"position:absolute;left:0;right:0;bottom:0;top:56px;'+"
    "'top:calc(56px + env(safe-area-inset-top));display:flex;align-items:center;justify-content:center;'+"
    "'padding:8px;box-sizing:border-box;overflow:auto;-webkit-overflow-scrolling:touch\"></div>';"
    "(document.body||document.documentElement).appendChild(v);"
    "v.querySelector('#sm-nas-viewer-close').addEventListener('click',function(ev){"
    ...
    "var name=decodeURIComponent((path.split('/').pop()||'File'));"
    "var dl=u;"
